...
class EmployeeBonus(models.Model):
    ...
    state = fields.Selection([('draft', 'Draft'),
                              ...
                              ('approve', 'Approved')], string='Status', readonly=True, default='draft', help="Gives the status of Employee Bonus.", track_visibility='onchange')
    ...
    def action_set_to_draft(self):
        ...
        self.message_post(message_type="email", subtype='mail.mt_comment', body=_('Bonus Set to Draft.'))
...
class EmployeeBonusLines(models.Model):
    ...
    state = fields.Selection([('draft', 'Draft'),
                              ...
                              ('approve', 'Approved'),
                              ('cancel', 'Cancelled'),
                              ('done', 'Done')], string='Status', readonly=True, default='draft', help="Gives the status of Employee Bonus.", track_visibility='onchange')
